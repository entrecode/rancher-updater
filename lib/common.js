...
const common = {
  ...
  .then(() => {
    ...
    case 'initBalanced':
      ...
      .concat(yamls.dockerServiceNew);
      yamls.rancherBalancerNew = yamls.rancherBalancerNew
      .concat(yamls.rancherServiceNew);

      break;
    case 'balanced':
      yamls.dockerBalancerNew = yamls.dockerBalancerNew
      .concat(yamls.dockerServiceOld, yamls.dockerServiceNew);
      yamls.rancherBalancerNew = yamls.rancherBalancerNew
      .concat(yamls.rancherServiceOld, yamls.rancherServiceNew);
