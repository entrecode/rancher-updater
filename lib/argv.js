...
.describe('env', 'The id of environment which should be updated. Defaults to cachena.')
.alias('e', 'environment')
.nargs('env', 1)
.default('env', '1a45')

.describe('s', 'The service name which should be updated.')
.alias('s', 'service-name')
.nargs('s', 1)
.demand('s')

.describe('v', 'The version tag to which you want to update.')
.alias('v', 'version')
.nargs('v', 1)
.demand('v')
...
.describe('e', 'Additional environment variables for the docker-compose template.')
.nargs('e', 1)
